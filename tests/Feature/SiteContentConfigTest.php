...
test('site content config exposes owner editable homepage media paths', function () {
    ...
    expect($content)
        ...
        ->and($content['hero']['slides'][0]['src'])->toBe('content/hero/Hero (1).jpg')
...
test('homepage owner editable sections render from site content config', function () {
    ...
    expect($html)
        ...
        ->toContain('Hero (1).jpg')
        ->toContain('69-01-36.jpg')
        ->toContain('annual-report-2568-kmre.jpg')
        ->toContain('khlong_yang.jpg');
});
