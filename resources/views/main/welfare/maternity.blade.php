...
@section('title', 'สวัสดิการคลอดบุตร') {{-- Page title --}}

@section('content')
    <div class="container mx-auto px-4 py-12">
        <h1 class="text-4xl font-extrabold text-center text-blue-700 mb-10">สวัสดิการคลอดบุตร</h1>

        <p class="text-lg text-gray-700 text-center mb-12 max-w-3xl mx-auto">
            สหกรณ์ออมทรัพย์ษะกอฟะฮ จำกัด มอบสวัสดิการคลอดบุตรเพื่อเป็นส่วนหนึ่งในการดูแลและสนับสนุนสมาชิก
        </p>
            ...
            <div class="flex flex-col md:flex-row items-center justify-center gap-8 mb-8"> {{-- Added mb-8 for spacing before documents list --}}
                <div class="md:w-1/2 text-center md:text-left">
                    <p class="text-xl text-gray-700 leading-relaxed mb-4">
                        สวัสดิการคลอดบุตร ตั้งแต่ <strong class="text-green-600">1,000-2,000 บาท</strong>
                        <br>(ต่อบุตรที่คลอดโดยไม่จำกัด)
                    </p>
                    <p class="text-lg text-gray-700 leading-relaxed">
                        ยื่นเอกสารขอรับสวัสดิการภายใน <strong class="text-blue-600">90 วัน</strong> นับจากวันคลอดบุตร
                    </p>
                </div>
