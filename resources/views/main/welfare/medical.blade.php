...
@section('title', 'สวัสดิการช่วยเหลือค่ารักษาพยาบาล') {{-- Page title --}}

@section('content')
    <div class="container mx-auto px-4 py-12">
        <h1 class="text-4xl font-extrabold text-center text-blue-700 mb-10">สวัสดิการช่วยเหลือค่ารักษาพยาบาล</h1>

        <p class="text-lg text-gray-700 text-center mb-12 max-w-3xl mx-auto">
            สหกรณ์ออมทรัพย์ษะกอฟะฮ จำกัด มอบสวัสดิการช่วยเหลือค่ารักษาพยาบาลเพื่อแบ่งเบาภาระและดูแลสุขภาพของสมาชิก
        </p>
        ...
        <section class="bg-white rounded-lg shadow-lg p-8 mb-12 border-t-4 border-green-500">
            ...
            <div class="flex flex-col md:flex-row items-center justify-center gap-8 mb-8"> {{-- Added mb-8 for spacing before documents list --}}
                <div class="md:w-1/2 text-center md:text-left">
                    <p class="text-xl text-gray-700 leading-relaxed mb-4">
                        ช่วยเหลือค่ารักษาพยาบาล (ผู้ป่วยใน) ตั้งแต่ <strong class="text-green-600">100-200 บาท/คืน</strong>
                        (ตามระดับอายุสมาชิก)
                        <br><strong class="text-red-600">*ทั้งนี้ต้องไม่เกิน 10 คืน/ปี</strong>
                    </p>
                    <p class="text-lg text-gray-700 leading-relaxed">
                        ยื่นเอกสารขอรับสวัสดิการภายใน <strong class="text-blue-600">90 วัน</strong> นับจากวันออกจากโรงพยาบาล
                    </p>
                </div>
                <div class="md:w-1/2 flex justify-center">
                    <img src="{{asset('images/welfare/สวัสดิการช่วยเหลือค่ารักษาพยาบาล.jpg')}}" alt=""
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 text-lg text-gray-700">
                ...
                <div class="flex items-start">
                    ...
                    <span>สำเนาบัตรประชาชนของสมาชิก</span>
                </div>
