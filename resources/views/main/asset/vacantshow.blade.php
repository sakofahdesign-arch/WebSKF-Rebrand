...
@section('title', $detail->title ?? 'รายละเอียดที่ดิน')
...
<div class="bg-gray-50 min-h-screen text-gray-800 font-sans pb-16" data-theme="light" x-data="{ loaded: false }" x-init="() => { setTimeout(() => loaded = true, 50) }">
    ...
    <div class="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-30">
        <div class="container mx-auto px-4 py-3 max-w-7xl flex justify-between items-center">
            {{-- สมมติว่า Route กลับหน้ารายการที่ดินคือ /vacantList --}}
            <a href="/vacantList" class="btn btn-ghost btn-sm gap-2 text-gray-500 hover:text-emerald-600 font-normal">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                @if ($image && $image->isNotEmpty())
                    <div class="rounded-2xl overflow-hidden shadow-lg border border-gray-100 relative group">
                        ...
                        <div class="absolute top-4 left-4">
                            <span class="badge badge-primary badge-lg shadow-md border-none bg-emerald-600 text-white">
                                <i class="fas fa-map-marked-alt mr-2"></i> ที่ดินเปล่า
                            </span>
                        </div>
                    </div>
            ...
            <div class="lg:col-span-1">
                <div class="sticky top-20 space-y-6">
                        ...
                        <div class="card-body p-6">
                            ...
                            <div class="prose text-gray-600 leading-relaxed text-sm space-y-4">
                                @if(!empty($detail->description1))
                                    <div>
                                        <h3 class="font-bold text-gray-800 mb-1"><i class="fas fa-info-circle text-emerald-500 mr-1"></i> รายละเอียด 1</h3>
                                ...
                                @if(!empty($detail->description2))
                                    <div>
                                        <h3 class="font-bold text-gray-800 mb-1"><i class="fas fa-map text-emerald-500 mr-1"></i> รายละเอียด 2</h3>
                    ...
                    <div class="card bg-gradient-to-br from-emerald-600 to-teal-700 text-white shadow-xl">
                        <div class="card-body p-6">
                            ...
                            <div class="card-actions justify-center">
                                <a href="tel:{{ preg_replace('/[^0-9]/', '', $detail->contact ?? '') }}" class="btn bg-white text-emerald-700 border-none hover:bg-gray-100 w-full rounded-full">
