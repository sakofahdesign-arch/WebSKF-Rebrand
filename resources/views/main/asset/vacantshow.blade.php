...
@section('title', $detail->title ?? 'รายละเอียดที่ดิน') {{-- Page title --}}
@push('styles')
...
@section('content')
    ...
    <div class="container mx-auto px-4 py-12">
        <h1 class="text-4xl font-extrabold text-center text-blue-700 mb-10">รายละเอียดที่ดิน</h1>
        <div class="flex flex-col lg:flex-row items-center lg:items-start gap-8">
            ...
            <div
                ...
                <div class="mt-8 text-center lg:text-left">
                    <a href="/homeList" class="inline-flex items-center bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-6 rounded-full transition duration-300">
