    ...
    <div class="container mx-auto px-4 py-12">
        <div class="flex flex-col lg:flex-row gap-12">
            <div class="lg:w-3/4 bg-white rounded-2xl shadow-xl p-6 md:p-8 border-t-4 border-blue-500">
                <h1 class="text-3xl md:text-4xl font-extrabold text-blue-800 mb-4">{{ $news->title ?? 'ไม่พบหัวข้อข่าว' }}</h1>
                <p class="text-gray-500 text-sm mb-6 flex items-center">
                    <svg class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                ...
                <div class="mt-12 text-center">
                    <a href="/activity" class="inline-flex items-center bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-6 rounded-full transition duration-300">
                        <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 15l-3-3m0 0l3-3m-3 3h8M3 12a9 9 0 1118 0 9 9 0 01-18 0z"></path></svg>
                        กลับสู่หน้าข่าวสาร
                    </a>
                </div>
            </div>
            <div class="lg:w-1/4">
                <div class="bg-white rounded-2xl shadow-xl p-6 border-t-4 border-purple-500 sticky top-8">
                    <h2 class="text-2xl font-bold text-purple-800 mb-6 border-b-2 border-purple-200 pb-3">ข่าวสารอื่นๆ</h2>
