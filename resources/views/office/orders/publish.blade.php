...
<div class="container mx-auto">
    <h1 class="text-2xl md:text-3xl font-bold text-gray-800 mb-6">ประกาศภายใน</h1>

    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        <div class="p-6 border-b">
            <h3 class="text-xl font-semibold text-gray-800">รายการเอกสารทั้งหมด</h3>
        </div>
                    ...
                    @forelse ($data as $item)
                        <tr class="border-t hover:bg-gray-50">
                            ...
                            <td class="p-4 text-center">
                                <a href="{{ url('file/inside_publish/' . $item->uploadfile) }}" target="_blank" class="inline-flex items-center justify-center w-10 h-10 bg-green-500 text-white rounded-md hover:bg-green-600 transition-colors duration-200" aria-label="ดาวน์โหลด {{ $item->title }}">
