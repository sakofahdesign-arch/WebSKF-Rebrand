...
<div class="container mx-auto">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-center mb-6">
        ...
        <a href="{{route('news.create')}}" class="mt-4 sm:mt-0 inline-flex items-center px-4 py-2 bg-green-600 text-white font-bold rounded-lg hover:bg-green-700 transition duration-300">
            ...
            <table class="w-full text-sm">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="p-4 font-semibold text-gray-600 uppercase tracking-wider text-center">วันที่อัปโหลด</th>
                        ...
                        <tr class="border-t hover:bg-gray-50">
                            ...
                            <td class="p-4 text-center">
                                <div class="flex justify-center items-center gap-2">
                                    <a href="{{route('news.edit',  $item->news_number)}}" class="inline-flex items-center justify-center w-10 h-10 bg-yellow-400 text-white rounded-md hover:bg-yellow-500 transition-colors duration-200" aria-label="แก้ไข">
                                        <i class="fas fa-pen"></i>
                                    </a>
                                    <a href="{{route('news.destroy', $item->news_number)}}" class="delete-btn inline-flex items-center justify-center w-10 h-10 bg-red-500 text-white rounded-md hover:bg-red-600 transition-colors duration-200" aria-label="ลบ">
