...
@section('content')
    <div class="container mx-auto">
        ...
        <div class="bg-white p-6 rounded-xl shadow-lg">
            <form action="{{ route('news.update', ['news_number' => $news->news_number]) }}" method="POST"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="mt-2 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                                @foreach ($pictures as $pic)
                                    <div class="relative">
                                        ...
                                        {{-- Note: Delete functionality for individual images requires more complex logic --}}
                                    </div>
                                @endforeach
                            </div>
                        </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input id="uploadedFiles" name="uploadedFiles[]" type="file"
