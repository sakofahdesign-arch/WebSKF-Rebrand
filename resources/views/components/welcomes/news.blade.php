            ...
            <div class="mb-8 border-b border-gray-200">
                <nav class="-mb-px flex flex-wrap justify-center space-x-2 sm:space-x-4 lg:space-x-6" aria-label="Tabs">
                    ...
                    <button @click="activeTab = 'ประชาสัมพันธ์'"
                        :class="activeTab === 'ประชาสัมพันธ์' ? 'border-indigo-500 text-indigo-600' :
                    ...
                    <button @click="activeTab = 'สวัสดิการ'"
                        :class="activeTab === 'สวัสดิการ' ? 'border-indigo-500 text-indigo-600' :
                            'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'"
                        class="group inline-flex items-center py-4 px-1 border-b-2 font-medium text-sm transition-colors duration-200">
                    ...
                    <button @click="activeTab = 'มูลนิธิ'"
                        :class="activeTab === 'มูลนิธิ' ? 'border-indigo-500 text-indigo-600' :
                            'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'"
                        class="group inline-flex items-center py-4 px-1 border-b-2 font-medium text-sm transition-colors duration-200">
                    ...
                    <button @click="activeTab = 'สินเชื่อ'"
                        :class="activeTab === 'สินเชื่อ' ? 'border-indigo-500 text-indigo-600' :
                            'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'"
                        class="group inline-flex items-center py-4 px-1 border-b-2 font-medium text-sm transition-colors duration-200">
