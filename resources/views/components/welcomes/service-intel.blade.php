<section class="py-16 bg-gray-50">
    <div class="container mx-auto px-4">
        ...
        <div class="text-center mb-12">
            <h2 class="text-3xl md:text-4xl font-extrabold text-gray-800">บริการและข่าวสาร</h2>
        ...
        <div class="grid lg:grid-cols-5 gap-8 items-start">
            ...
            <div class="lg:col-span-3 grid grid-cols-1 sm:grid-cols-2 gap-6">
                <a href="{{ route('register') }}" class="group block bg-white p-6 rounded-2xl shadow-lg border border-transparent hover:border-green-500 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    ...
                    <h3 class="text-xl font-bold text-gray-800 mb-1">สมัครสมาชิก</h3>
                ...
                <a href="{{ route('deposit') }}" class="group block bg-white p-6 rounded-2xl shadow-lg border border-transparent hover:border-blue-500 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    ...
                    <h3 class="text-xl font-bold text-gray-800 mb-1">บริการเงินฝาก</h3>
                ...
                <a href="{{ route('credit_service') }}" class="group block bg-white p-6 rounded-2xl shadow-lg border border-transparent hover:border-yellow-500 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    ...
                    <h3 class="text-xl font-bold text-gray-800 mb-1">บริการสินเชื่อ</h3>
                ...
                <a href="{{ route('document') }}" class="group block bg-white p-6 rounded-2xl shadow-lg border border-transparent hover:border-gray-500 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    ...
                    <h3 class="text-xl font-bold text-gray-800 mb-1">เอกสารสมาชิก</h3>
                    <p class="text-gray-500 text-sm">ดาวน์โหลดแบบฟอร์มและเอกสารต่างๆ</p>
                </a>
            </div>

            <div class="lg:col-span-2 bg-white rounded-2xl shadow-xl border p-6">
                <div class="flex items-center mb-4">
                     <svg class="w-8 h-8 text-[#1877F2]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd"></path></svg>
                     <h3 class="text-2xl font-bold text-gray-800 ml-3">ข่าวสารจาก Facebook</h3>
                </div>
                 <div class="w-full h-[450px] flex justify-center rounded-lg overflow-hidden">
                    <iframe
                        ...
                        width="380" height="450" style="border:none;overflow:hidden" scrolling="no" frameborder="0"
