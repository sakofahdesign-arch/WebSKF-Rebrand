    ...
    return (
        ...
        >
            ...
            >
                <motion.div
                    className={cn(
                        "absolute top-1/2 flex w-fit -translate-y-1/2 items-center",
                        centerActive ? "left-1/2" : "inset-x-0 mx-auto justify-center",
                    )}
                    animate={{
                        x: centerActive ? -(currentIndex * safeSlideWidth + safeSlideWidth / 2) : 0,
                    }}
                    transition={transition}
                >
